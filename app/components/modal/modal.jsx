        ...
        return (
            <div id="cardModal" ref={(ref) => (this.cardModal = ref)} className={`modal ${modalClass}`}>
                <div className="modal-content">
                    <span onClick={this.props.onHandleModalClose} className="close"><i className="glyphicon glyphicon-remove"></i></span>
                    <form>
                        ...
                        <button type="submit" className="btn btn-primary"
                            onClick={_.partial(this.props.onHandleFormSubmit, {
                                'formData': this.state,
                            })}
                        >SAVE
                        </button>
                        <button type="cancel" className="btn btn-default btn-cancel" onClick={this.props.onHandleFormCancel}>CANCEL</button>
                    </form>
                </div>
            </div>
        );
...
Modal.propTypes = {
    ...
    onHandleFormCancel: PropTypes.func,
};
